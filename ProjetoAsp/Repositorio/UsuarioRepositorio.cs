        ...
        public class UsuarioRepositorio(IConfiguration configuration)
        {
            ...
            public void AdicionarUsuario(Usuario usuario)
            {
                ...
                using (var conexao = new MySqlConnection(_conexaoMySQL))
                {
                    ...
                    MySqlCommand cmd = new("INSERT INTO tbUser (Nome, Email, Senha) VALUES (@Nome,@Email,@Senha)", conexao);
            ...
            public Usuario ObterUsuario(string email)
            {
                ...
                using (var conexao = new MySqlConnection(_conexaoMySQL))
                {
                    ...
                    MySqlCommand cmd = new("SELECT * FROM tbUser WHERE Email = @email", conexao);
